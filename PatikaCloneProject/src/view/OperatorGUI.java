...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator) {
        ...
        add(wrapper);
        wrapper.setLayout(new BorderLayout()); // JPanel'in içeriği BorderLayout ile düzenlenecek
        wrapper.add(new JLabel("Hoşgeldiniz, " + operator.getName()), BorderLayout.CENTER);
        setSize(1000, 500);
